		...
		<div className={styles.header_wrapper}>
			...
			<div className={styles.header_content}>
				...
				<p className={styles.header_text}>
					...
					четверть века. Всё это время сфера стремительно меняется&nbsp;и,
					кажется, не&nbsp;планирует сбавлять обороты. Как это было
					в&nbsp;России&nbsp;&mdash; от&nbsp;зарождения рынка до&nbsp;сервиса
					мирового уровня&nbsp;&mdash; вспоминаем вместе со&nbsp;СДЭК, одним
					из&nbsp;крупнейших логистических операторов страны.
				</p>
			</div>
		</div>
	</header>
