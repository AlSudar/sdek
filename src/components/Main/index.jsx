        ...
        <div className={styles.content_third}>
          <Fade triggerOnce direction='up'>
            ...
            <p className={styles.content_text}>
              ...
              представитель интернет-магазина привозил на склад или в{'\u00A0'}
              офис оператора коробки с заказами, их тут же принимали курьеры и в
              тот же день развозили по адресам. Учет вели исключительно вручную,
              на бумажках и в таблицах.
            </p>
            <blockquote className={styles.content_quote}>
              <p className={styles.content_quote_text}>
                &laquo;Все изменил финансовый кризис 2008{'\xA0'}года.
      ...
      <div className={styles.main_content}>
        ...
        <div className={styles.content_first}>
          <Fade triggerOnce direction='up'>
            ...
            <p className={styles.content_text}>
              Тенденции, которые с высокой вероятностью станут массовыми в
