          ...
          <div className={styles.content_second}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                действовавшие не&nbsp;системно и&nbsp;без привязки
          ...
          <Fade triggerOnce direction='up'>
            <div className={styles.content_first}>
              ...
              <p className={styles.content_text}>
                ...
                в&nbsp;основном, из&nbsp;офлайн-магазинов
                и&nbsp;по&nbsp;печатным каталогам. Ритейлеры, которые прежде
                предпочитали выстраивать всю логистику сами, понемногу начали
                отдавать эту часть работы на&nbsp;аутсорс. Параллельно
            ...
            <Fade triggerOnce direction='up'>
              ...
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
                  ...
                  название: &laquo;Служба доставки
                  &bdquo;Экспресс-курьер&ldquo;&raquo;, сокращенно
          ...
          <div className={styles.content_third}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                их&nbsp;тут&nbsp;же принимали курьеры и&nbsp;в&nbsp;тот
                же&nbsp;день развозили по&nbsp;адресам. Учет вели исключительно
                вручную, на бумажках и&nbsp;в&nbsp;таблицах.
              </p>
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
          ...
          <Fade triggerOnce direction='up'>
            <div className={styles.content_first}>
              ...
              <p className={styles.content_text}>
                ...
                случился. Объем рынка вырос с&nbsp;240 млрд рублей в&nbsp;2011
            ...
            <Fade triggerOnce direction='up'>
              ...
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
                  ...
                  франчайзинга&nbsp;&mdash; с&nbsp;тех пор склады и&nbsp;офисы
                  под этим брендом открывают предприниматели на&nbsp;местах. Так
          ...
          <div className={styles.content_third}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                получения заказов&nbsp;&mdash; так появилась возможность
                примерки в&nbsp;присутствии курьера, частичного выкупа, оплаты
                при получении и&nbsp;другие опции.
              </p>
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
            ...
            <Fade triggerOnce direction='up'>
              ...
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
                  ...
                  курьеров и&nbsp;клиентов. Так ИТ-направление стало
                  неотъемлемой частью всех этапов работы, а&nbsp;логистические
                  операторы стали еще и&nbsp;технологическими компаниями&raquo;
                </p>
                <div className={styles.content_quote_author}>
                  <Image
        ...
        <div id='main-content-2020' className={styles.main_content}>
          ...
          <Fade triggerOnce direction='up'>
            <div className={styles.content_first}>
              ...
              <p className={styles.content_text}>
                ...
                продолжал стремительно расти: в&nbsp;2019&ndash;2023
                годах&nbsp;&mdash; в&nbsp;8 раз.
              </p>
          ...
          <div className={styles.content_second}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                Безусловно, на&nbsp;сфере логистики отразилась и&nbsp;пандемия,
                и ограничения 2022&nbsp;года. Операторы внедряли бесконтактную
              ...
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
                  ...
                  маркетплейсов и&nbsp;рост их&nbsp;сетей пунктов выдачи
                  заказов. Вместе с&nbsp;увеличением количества отправлений
                  логистические операторы обнаружили смещение спроса
                  с&nbsp;доставки &laquo;последней мили&raquo;
                  на&nbsp;фулфилмент, магистральные перевозки и&nbsp;услуги
                  распределенного хранения грузов в&nbsp;разных регионах: чем
                  ближе склад к&nbsp;покупателю, тем быстрее и&nbsp;дешевле
                  доставка.
                </p>
                <p className={styles.content_quote_text}>
                  Также стала популярной услуга для селлеров&nbsp;&mdash;
                  доставки груза до маркетплейса, когда оператор забирает груз
          ...
          <div className={styles.content_third}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                интервал или к&nbsp;конкретному времени. Кроме того, растет
                спрос на&nbsp;доставку &laquo;по&nbsp;клику&raquo;, когда
                получатель может в&nbsp;любой момент нажать кнопку,
                и&nbsp;курьер привезёт заказ в&nbsp;течение 30 минут.
              </p>
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
          ...
          <div className={styles.content_fourth}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                для предпринимателей СДЭК.Медиа. Благодаря ему компании могут
                ...
                использовать офлайн-терминалы&nbsp;&mdash; и&nbsp;упрощает
                расчеты для всех участников.
              </p>
              <blockquote className={styles.content_quote}>
                <p className={styles.content_quote_text}>
          ...
          <div className={styles.content_second}>
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                услуги&nbsp;&mdash; от&nbsp;сервисов приема платежей
            ...
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                во многом благодаря ориентированности на&nbsp;запросы конечного
            ...
            <Fade triggerOnce direction='up'>
              ...
              <p className={styles.content_text}>
                ...
                и автоматизацию. В&nbsp;частности, нейросети помогают строить
