        ...
        <div className={styles.content_second}>
          <Fade triggerOnce direction='up'>
            ...
            <p className={styles.content_text}>
              ...
              несистемно и без привязки к каким-либо стандартам.
            </p>
            <blockquote className={styles.content_quote}>
              <p className={styles.content_quote_text}>
                «Сети магистральных перевозок только формировались, поэтому,
                чтобы доставить отправление между городами, нередко
        ...
        <Fade triggerOnce direction='up'>
          <div className={styles.content_first}>
            ...
            <p className={styles.content_text}>
              ...
              офлайн-магазинов и по печатным каталогам. Ритейлеры, которые
              ...
              новое направление бизнеса — доставка физлицам.
            </p>
          </div>
        </Fade>
        <div className={styles.content_second}>
