    ...
    <>
      <Head>
        ...
        <meta
          key='description'
          name='description'
          content='Как лидеры российского бизнеса адаптируются к изменениям в потребительском поведении и экономике в целом'
        />
        <meta
          key='og:description'
        ...
        <meta
          key='title'
          name='title'
          content='6 трендов взаимодействия бизнеса с клиентами'
        />
        <meta
          key='og:title'
          property='og:title'
      ...
      <div className={cn(myFont.className)}>
        ...
        <div className={cn(style.bannerBulgakov)}>
          <Banner
            ...
            author={
              width && width > 720
                ? `Кирилл Булгаков, заместитель <br />генерального директора по&nbsp;программным продуктам и&nbsp;сервисам Холдинга&nbsp;Т1,<br /> управляющий&nbsp;директор российского вендора НОТА&nbsp;(16+) Холдинга&nbsp;Т1`
                : `Кирилл Булгаков, заместитель <br />генерального директора по&nbsp;программным продуктам и&nbsp;сервисам Холдинга&nbsp;Т1, управляющий&nbsp;директор российского вендора НОТА&nbsp;(16+) Холдинга&nbsp;Т1`
            }
