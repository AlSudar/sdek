	...
	<main className={styles.main}>
			...
			<div className={styles.main_content}>
				<div className={styles.content_first}>
					...
					<p className={styles.content_text}>
						...
						основном, документы. Приметы времени: «дикий» рынок, множество
						локальных микро-компаний и появление в стране международных
						операторов, на которых старались равняться.
					</p>
				</div>
				<div className={styles.content_second}>
					<h2 className={styles.content_second_title}>
						Аналоговый мир и логистический хаос
					</h2>
					<p className={styles.content_text}>
						В то время бизнес обменивался бумажными документами: это было
						последнее десятилетие, когда мир оставался аналоговым. Логистические
						компании обеспечивали уход от монополии почты. Доставкой занимались,
						как правило, частные игроки, действовавшие несистемно и без привязки
						к каким-либо стандартам.
					</p>
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							«Сети магистральных перевозок только формировались, поэтому, чтобы
							доставить отправление между городами, нередко договаривались с
							водителями автобусов или проводниками в поездах. Это было время
		...
		<div className={styles.main_wrapper}>
			<div className={styles.main_content}>
				<div className={styles.content_first}>
					<h2 className={styles.content_first_title}>
						2000-е: торговля выходит в онлайн
					</h2>
					<p className={styles.content_text}>
						Люди привыкали заказывать товары с доставкой – в основном, из
						офлайн-магазинов и по печатным каталогам. Ритейлеры, которые прежде 
						предпочитали выстраивать всю логистику сами, понемногу начали
						отдавать эту часть работы на аутсорс. Параллельно появлялись первые
						интернет-магазины, которым тоже нужны были услуги курьеров. Так для
						логистических операторов формировалось новое направление бизнеса —
						доставка физлицам.
					</p>
				</div>
				<div className={styles.content_second}>
					<h2 className={styles.content_second_title}>
						Запускали магазин — получилась служба доставки
					</h2>
					<p className={styles.content_text}>
						С распространением компьютеров и интернета предприниматели поверили
						в будущее онлайн-торговли. В отличие от продавцов, покупатели не
						спешили менять привычки, и многие интернет-магазины закрывались
						вскоре после запуска.
					</p>
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							«Эта участь постигла в 2000 году и один новосибирский
							интернет-магазин. Когда проект пришлось свернуть, курьерский
							отдел, изначально созданный для нужд магазина, стал
							самостоятельным бизнесом и получил название: «Служба доставки
				...
				<div className={styles.content_third}>
					<h2 className={styles.content_third_title}>В поисках точек роста</h2>
					<p className={styles.content_text}>
						...
						оператора коробки с заказами, их тут же принимали курьеры и в тот же
						день развозили по адресам. Учет вели исключительно вручную, на
		...
		<div className={styles.main_wrapper}>
			<div className={styles.main_content}>
				<div className={styles.content_first}>
					...
					<p className={styles.content_text}>
						Взлёт электронной коммерции, который предрекали визионеры, случился.
						Объем рынка вырос с 240 млрд рублей в 2011 году до 1,62 трлн в
						2019-м, и это было только началом (итог 2023 года — уже 7,8 трлн
						рублей). Логистические компании, чтобы «оседлать волну», стремились
						закрыть потребности интернет-магазинов: автоматизировали обработку
						отправлений, запускали услуги фулфилмента и — главное — расширяли
				...
				<div className={styles.content_second}>
					...
					<p className={styles.content_text}>
						Раз теперь магазины не ограничены пределами района или города, они
						хотели охватить как можно больше территорий. А, значит, сотрудничать
						с теми логистическими операторами, которые могут предложить широкую
						сеть подразделений. Кто‑то шёл традиционным путём и открывал
					...
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							...
							франчайзинга — с тех пор склады и офисы под этим брендом открывают
							предприниматели на местах. Так из регионального оператора компания
							в момент стала заметным федеральным игроком, а затем вырвалась в
							лидеры»
						</p>
						<div className={styles.content_quote_author}>
							<Image
				...
				<div className={styles.content_third}>
					...
					<p className={styles.content_text}>
						...
						логистический сервис. Чтобы соответствовать темпам рынка, важно было
					...
					<p className={styles.content_text}>
						...
						с их системами автоматизации. Покупатели, в свою очередь, хотели
						максимально удобного получения заказов — так появилась возможность
						примерки в присутствии курьера, частичного выкупа, оплаты при
						получении и другие опции.
					</p>
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							«Если раньше мы перенимали опыт западных коллег, теперь российские
							операторы по уровню сервиса и технологичности решений вырвались
							вперед»
						</p>
						<div className={styles.content_quote_author}>
							<Image
				...
				<div className={styles.content_fourth}>
					<h2 className={styles.content_fourth_title}>Логистика уходит в ИТ</h2>
					<p className={styles.content_text}>
						Объём отправлений в сегменте электронной коммерции увеличивался со
						скоростью до 70% в год. Этот рост стал драйвером для цифровизации и
						логистической отрасли. Если в начале 2000-х операторы использовали
						простые программы складского учёта, то теперь требовались системы,
						интегрированные друг с другом и внешними ресурсами, такими как ПО
						интернет-магазинов.
					</p>
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							...
							управление транспортными цепочками. Затем появились онлайн-сервисы
							и мобильные приложения для курьеров и клиентов. Так ИТ-направление
							стало неотъемлемой частью всех этапов работы, а логистические
						...
						<div className={styles.content_quote_author}>
							...
							<div className={styles.content_quote_author_info}>
								...
								<p className={styles.content_quote_author_text}>
									Руководитель департамента логистических продуктов СДЭК
								</p>
							</div>
						</div>
					</blockquote>
		...
		<div className={styles.main_wrapper}>
			<div className={styles.main_content}>
				<div className={styles.content_first}>
					<h2 className={styles.content_first_title}>
						2020-е: ускорение доставки, маркетплейсы и экосистемы
					</h2>
					<p className={styles.content_text}>
						...
						торговли продолжал стремительно расти: в 2019–2023 годах — в 8 раз.
					</p>
					<div className={styles.content_statistics}>
						<img
							className={styles.content_statistics_icon}
				...
				<div className={styles.content_second}>
					...
					<p className={styles.content_text}>
						Безусловно, на сфере логистики отразилась и пандемия, и ограничения
						2022 года. Операторы внедряли бесконтактную доставку и новые способы
						оплаты, вводили удаленный и гибридный режим работы, а также
						оптимизировали процессы, чтобы компенсировать нехватку курьеров в
					...
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							...
							заказов. Вместе с увеличением количества отправлений логистические
							операторы обнаружили смещение спроса с доставки «последней мили»
							на фулфилмент, магистральные перевозки и услуги распределенного
							хранения грузов в разных регионах: чем ближе склад к покупателю,
							тем быстрее и дешевле доставка.
						</p>
						<p className={styles.content_quote_text}>
							Также стала популярной услуга для селлеров — доставки груза до
							маркетплейса, когда оператор забирает груз у селлера, упаковывает
							и обрабатывает по требованиям конкретного маркетплейса, — а затем
						...
						<div className={styles.content_quote_author}>
							...
							<div className={styles.content_quote_author_info}>
								...
								<p className={styles.content_quote_author_text}>
									Руководитель департамента логистическихпродуктов СДЭК
								</p>
							</div>
						</div>
					</blockquote>
				...
				<div className={styles.content_third}>
					...
					<p className={styles.content_text}>
						...
						сортировочного центра, а из ближайшего пункта выдачи заказов. Такая
						схема позволяет доставлять отправления не в течение дня, как
						раньше,а в короткий интервал или к конкретному времени. Кроме того,
						растет спрос на доставку «по клику», когда получатель может в любой
						момент нажать кнопку, и курьер привезёт заказ в течение 30 минут.
					</p>
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							«Доставлять отправления быстро и точно рассчитывать время помогают
							системы «умной» маршрутизации, которые учитывают загрузку курьера,
							ситуацию на дорогах, количество свободных курьеров поблизостии
							другие параметры»
						</p>
						<div className={styles.content_quote_author}>
							<Image
				...
				<div className={styles.content_fourth}>
					...
					<blockquote className={styles.content_quote}>
						<p className={styles.content_quote_text}>
							...
							брендов. Проект помогает компании развивать свое международное
		...
		<div className={styles.main_wrapper}>
			<div className={styles.main_content}>
				...
				<div className={styles.content_second}>
					...
					<p className={styles.content_text}>
						Российский логистический сервис смог стать одним из лучших во многом
						благодаря ориентированности на запросы конечного получателя. Так
						будет и дальше. В частности, появится больше опций, которые можно
						настраивать на ходу в последний момент. Например, добавлять и
						убирать товары из уже собранного заказа или менять время и адрес
					...
					<p className={styles.content_text}>
						...
						получения заказов. А мультибрендовые пункты выдачи позволят сделать
						логистику «последней мили» дешевле за счет экономии на арендных
						площадях. К тому же забирать все заказы в одном месте — это удобно.
					</p>
					<h2 className={styles.content_second_title}>
					...
					<p className={styles.content_text}>
						...
						автоматизацию. В частности, нейросети помогают строить транспортные
						маршруты, отвечать на запросы в службу поддержки и даже искать
						потерявшиеся отправления по фото. В перспективе нейросети возьмут на
						себя ещё больше задач – от прогнозирования спроса до автономного
						управления процессом доставки.
					</p>
				</div>
			</div>
		</div>
