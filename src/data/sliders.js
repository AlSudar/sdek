export const dataFirstSlider = [
  ...
  [
    ...
    },
    {
      title: 'Как избежать',
      description:
        'Заранее продуманные условия совместного ведения бизнеса, включая распределение зон ответственности, помогут нивелировать возникновение конфликтных ситуаций. Также важно продумать условия прекращения бизнеса.',
    },
  ],
];
...
export const dataThirdSlider = [
  ...
  [
    {
      title: 'Ошибка 3',
      description: 'Самоустраниться от&nbsp;управления компанией',
    },
    {
      title: 'Что пошло не&nbsp;так',
      description:
