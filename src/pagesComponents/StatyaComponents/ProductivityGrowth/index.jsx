...
Для работы с&nbsp;грузом на&nbsp;многоярусных стеллажах используют автономные вилочные погрузчики и&nbsp;роботов для обслуживания полочных стеллажей (также называют CTU-роботами, от&nbsp;англ. carton transfer unit). Если погрузчики могут перевозить палеты весом <a href='https://www.comitas.ru/production/avtomatizatsiya-khraneniya-i-peredvizheniya-tovarov-na-baze-sobstvennogo-po/robotizirovannye-tekhnologii-i-sistemy/' target='_blank'>до&nbsp;3&nbsp;тыс.&nbsp;кг,</a> то&nbsp;CTU-роботы умеют размещать коробки в&nbsp;нужные ячейки весом до&nbsp;50&nbsp;кг. За&nbsp;один раз робот способен перевезти семь коробов и&nbsp;поднять их&nbsp;на&nbsp;высоту до&nbsp;12&nbsp;м. В&nbsp;результате эффективность сортировки и&nbsp;комплектования может увеличиться в&nbsp;3&ndash;4&nbsp;раза. <br /><br />
Чтобы провести инвентаризацию товаров в&nbsp;одной зоне, роботу нужно два часа. На&nbsp;аналогичный объем работы сотрудникам <a href='https://yandex.ru/blog/company/robolaba' target='_blank'>может понадобиться</a> до&nbsp;четырех недель."
        />
      </div>
    </>
  );
